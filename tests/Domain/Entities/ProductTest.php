...
class ProductTest extends TestCase
{
    ...
    public function testInstance()
    {
        ...
        $va1 = new Variant('sku1', [
            $op1->getValue('240ml'),
            $op2->getValue('1本'),
        ], new Price(new Money(130)));

        $va2 = new Variant('sku2', [
            $op1->getValue('500ml'),
            $op2->getValue('1本'),
        ], new Price(new Money(150)));

        $va3 = new Variant('sku3', [
            $op1->getValue('240ml'),
            $op2->getValue('24本'),
        ], new Price(new Money(80 * 24), new Money(130 * 24)));

        $va4 = new Variant('sku4', [
            $op1->getValue('500ml'),
            $op2->getValue('24本'),
        ], new Price(new Money(90 * 24), new Money(150 * 24)));

        $va5 = new Variant('sku5', [
            $op1->getValue('2L'),
            $op2->getValue('24本'),
        ], new Price(new Money(110 * 24), new Money(200 * 24)));

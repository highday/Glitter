...
<link rel="stylesheet" type="text/css" href="{{ asset('/css/glitter-guest.css') }}" media="all" />
@stack('styles')
<script>
...
<form id="logoutForm" role="form" method="POST" action="{{ url('/office/logout') }}">{{ csrf_field() }}</form>
@endif

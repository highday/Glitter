    ...
    <div class="container-fluid">
        ...
        <div class="row">
                ...
                <div class="form-card card">
                    <div class="card-block">
                        <div class="d-flex align-items-center mb-2">
                            <h2 class="card-title mb-0">レシート</h2>
                            <a href="#" class="ml-auto small">領収書</a>
                        </div>
                        <table class="table table-order_content mb-0">
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    <th colspan="3" class="text-right">送料<br><span class="text-muted small">発送 2件</span></th>
                                    <td class="text-right"><price value="1000"></price></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"><strong><price value="18500"></price></strong></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
                ...
                <div class="form-card card">
                    <div class="card-block">
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ml-auto status status-unpaid">
                                未払い
                            </span>
                        </div>
            ...
            <div class="col-lg-6">
                <div class="form-card card">
                    <div class="card-block">
                        <div class="d-flex align-items-center" data-toggle="collapse" data-target="#tray1">
                            <strong>#1</strong>
                            <span class="ml-3 text-danger">要対応</span>
                        </div>
                            ...
                            <div class="bg-faded">
                                <div class="d-flex">
                                    <div class="d-flex flex-wrap">
                                        <div class="m-3">
                                            <div class="card-title text-muted small mb-1">発送先</div>
                                            <address class="mb-0">〒110-0001<br>東京都台東区谷中2丁目<br>7-6-102<br>根本啓介<br>08033107564</address>
                                        </div>
                                    </div>
                                    <div class="d-flex flex-wrap">
                                        <div class="m-3">
                                            <div class="card-title text-muted small mb-1">運送業者</div>
                                            <div>未設定</div>
                                        </div>
                                        <div class="m-3">
                                            <div class="card-title text-muted small mb-1">送料</div>
                                            <div><price value="500"></price></div>
                                        </div>
                                        <div class="m-3">
                                            <div class="card-title text-muted small mb-1">追跡番号</div>
                                            <div class="mb-0">N/A</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-3 d-flex align-items-center justify-content-end small">
                                <span>ステータス変更</span>
                                <a href="#" class="d-inline-block px-2">発送済み</a>
                                ･
                                <a href="#" class="d-inline-block px-2">キャンセル</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-card card">
                    <div class="card-block">
                        <div class="d-flex align-items-center" data-toggle="collapse" data-target="#tray2">
                            <strong>#2</strong>
                            <span class="ml-3 text-success">発送完了 （ヤマト運輸 0123456789）</span>
                        </div>

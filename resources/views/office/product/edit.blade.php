...
<form id="product_form" role="form" method="POST" action="{{ route('glitter.office.product.update', $product->id) }}">
    {{ csrf_field() }}
                ...
                <div class="form-card card">
                    <div class="card-block">
                        ...
                        <div class="list-group list-group-flush">
                            @foreach($product->variants as $variant)
                            <a class="list-group-item list-group-item-action px-4" href="{{ route('glitter.office.product.variant.edit', $variant) }}">

                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group{{ $errors->has('variants.0.fulfillment_manual') ? ' has-danger' : '' }}">
                            <select class="form-control" name="variants[0][fulfillment_service]" style="width: auto;">
                                <option value="manual" {{ old('variants.0.fulfillment_service', $variant->fulfillment_service) == 'manual' ? 'selected' : '' }}>{{ trans('glitter::admin.product.fulfillment_manual') }}</option>
